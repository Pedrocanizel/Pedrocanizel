class BombaCombustivel:
    ...
    def _apresentar_abastecimento_se_possivel(self, litros_abastecidos: float, valor: float):
        if litros_abastecidos > self.quantidade_combustivel:
            print(f'Nao é possível abastecer, faltam {litros_abastecidos - self.quantidade_combustivel:.2f} litros')
    ...
    def adicionar_mais_combustivel(self, quantidade: float):
        if quantidade >= 0:
            ...
            print('Nao vai roubar combustível')
...
bomba.abastecer_por_litros(50)
bomba_alcool = BombaCombustivel('Alcool', 3.15, 150)
bomba_alcool.abastecer_por_litros(50)
